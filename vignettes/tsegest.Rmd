...
\[
  ...
  \sum_{j'} \gamma_{j'} s_{ij'k}
\]
alongside a structural model for counterfactual post progression survival times
\[
  U_{i,\psi} =  T_{C_i} + e^{\psi}T_{E_i}
\]
Here $T_{C_i}$ refers to the time spent after disease progression on control treatment, and $T_{E_i}$ refers to the time spent after disease progression on the experimental treatment.
